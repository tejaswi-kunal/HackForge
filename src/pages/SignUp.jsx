    ...
    return (
        <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-[#C9963A]/8 blur-[100px]" />
                <div className="absolute -bottom-32 -left-32 w-80 h-80 rounded-full bg-[#C9963A]/5 blur-[80px]" />
            </div>
            ...
            >
                ...
                <form onSubmit={handleSubmit(submittedData)} className="flex flex-col gap-4">
                    ...
                    {/* ✅ Username field — placeholder updated */}
                    <div className="flex flex-col gap-1">
                        ...
                        />
                        {errors.userName && (
                            <span className="text-red-400 text-xs pl-1">{errors.userName.message}</span>
                        )}
                    </div>
                    ...
                    {/* ✅ Shows actual backend error message, not error code */}
                    {error && (
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="btn w-full mt-1 rounded-xl border-none
